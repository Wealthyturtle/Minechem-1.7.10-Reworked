	...
	public CommonProxy()
	{
		final List<UniversalSingularity> universalSingularities = Arrays.asList(
				...
				new UniversalSingularity("general", Arrays.asList(
						...
						new UniversalSingularityWrapper("titanium", "blockTitanium", 90, 0x1C242E, 0x192029),
						new UniversalSingularityWrapper("tungsten", "blockTungsten", 79, 0xD6D6D6, 0xCACACA),
						new UniversalSingularityWrapper("uranium", "blockUranium", 86, 0x00CB40, 0x00C43E),
				...
				new UniversalSingularity("extraPlanets", Arrays.asList(
						new UniversalSingularityWrapper("blueGem", "blockBlueGem", 95, 0x38D7FF, 0x03C6F6),
						new UniversalSingularityWrapper("carbon", "blockCarbon", 66, 0x1D1D1D, 0x0F0F0F),
						new UniversalSingularityWrapper("crystal", "blockCrystal", 78, 0xE2E2E2, 0xC1C1C1),
						new UniversalSingularityWrapper("palladium", "blockPalladium", 93, 0xF0F0F0, 0xE2E2E2),
						new UniversalSingularityWrapper("redGem", "blockRedGem", 68, 0xFF3B0C, 0xF93100),
						new UniversalSingularityWrapper("whiteGem", "blockWhiteGem", 70, 0xC6C6C6, 0xA5A5A5)
				)),
