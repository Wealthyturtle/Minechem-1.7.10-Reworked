	...
	public CommonProxy()
	{
		final List<UniversalSingularity> universalSingularities = Arrays.asList(
				...
				new UniversalSingularity("draconicEvolution", Collections.singletonList(
						new UniversalSingularityWrapper("awakenedDraconium", "blockAwakenedDraconium", 80, 0xFF7200, 0xFF6600)
				)),
				...
				new UniversalSingularity("enderIO", Arrays.asList(
						...
						new UniversalSingularityWrapper("solarium", "blockSolarium", 73, 0x5C4527, 0x5A3E25),
				...
				new UniversalSingularity("general", Arrays.asList(
						...
						new UniversalSingularityWrapper("brass", "blocBrass", 67, 0xD89634, 0x8B5F1B),
