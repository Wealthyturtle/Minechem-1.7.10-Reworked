...
public class SunMiscSharedSecrets {
    private static final Unsafe unsafe = Unsafe.getUnsafe();
    private static JavaUtilJarAccess javaUtilJarAccess;
    private static SunMiscJavaLangAccess javaLangAccess;
    ...
    public static void setJavaLangAccess(SunMiscJavaLangAccess jla) {
        javaLangAccess = jla;
    }

    public static SunMiscJavaLangAccess getJavaLangAccess() {
