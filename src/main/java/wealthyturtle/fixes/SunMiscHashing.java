 ...
 */
public class SunMiscHashing{

    /**
     * Static utility methods only.
     */
    private SunMiscHashing() {
    ...
    private static class Holder {
         ...
         */
        static final SunMiscJavaLangAccess LANG_ACCESS;

        static {
            LANG_ACCESS = SunMiscSharedSecrets.getJavaLangAccess();
            if (null == LANG_ACCESS) {
    ...
    public static int randomHashSeed(Object instance) {
        ...
        if (sun.misc.VM.isBooted()) {
            ...
            int hashing_seed[] = {
                System.identityHashCode(SunMiscHashing.class),
